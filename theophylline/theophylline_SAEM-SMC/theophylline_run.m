% runs 50 estimation procedures using SAEM-SMC for the example in section 4.2
...
% in particular, the settings below reproduce the SAEM-SMC results in table
...
initstate = X0; 
   ...
   % produces inference via SAEM-SMC
   THETAmatrix_saem = saem_smc(model_param,parmask,parbase,yobs,initstate,saem_numit,warmup,fisherestim_iter,numparticles,N_threshold);
